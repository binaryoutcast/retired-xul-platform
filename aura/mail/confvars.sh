...
MOZ_APP_VERSION=`$PYTHON ${_topsrcdir}/aura/build/version2k.py --version ${_topsrcdir}/aura/mail/config/version.txt`
MOZ_APP_VERSION_DISPLAY=$MOZ_APP_VERSION
MOZ_BRANDING_DIRECTORY=aura/mail/branding
MOZ_OFFICIAL_BRANDING_DIRECTORY=aura/other-licenses/branding/interlink-uxp
